...
export default function AuthVerify() {
  ...
  return (
    <div className="min-h-screen bg-[#0b0f1a] flex items-center justify-center p-6">
      <div className="bg-[#0f1724] border border-white/10 rounded-2xl p-10 w-full max-w-sm text-center shadow-2xl">
        {status === "loading" && (
          <>
        ...
        {status === "success" && (
          <>
            ...
            <p className="text-slate-600 text-xs">Redirecting you now…</p>
          </>
        )}
